        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-4 offset-lg-2">
                    ...
                    <p>Puoi inserire una nuova categoria nel catalogo.&nbsp;<br>Compila il modulo!</p><a class="learn-more" href="#modalInserCategory" onclick='$("#modalInsertCategory").modal("show")'>Apri modulo</a></div>
