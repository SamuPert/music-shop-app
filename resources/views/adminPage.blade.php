        ...
        <div class="row">
            <div class="col-md-6" style="width: 490px;height: 180px;">
                <div class="box">
                    ...
                    <p class="description">Puoi inserire un nuovo utente nello staff.&nbsp;<br>Compila il modulo!</p><a class="learn-more" href="#">Apri modulo</a></div>
            </div>
            <div class="col-md-6" >
                <div class="box">
        ...
        <div class="row">
            <div class="col-md-6" style="height: 180px;">
                <div class="box">
                    ...
                    <p class="description">Puoi eliminare un utente dallo staff.&nbsp;<br>Compila il modulo!</p><a class="learn-more" href="#">Apri modulo</a></div>
            </div>
            <div class="col-md-6">
                <div class="box">
                    <h3 class="name"><i class="fa fa-remove icon"></i> Elimina Utente Registrato </h3>
                    <p class="description">Puoi eliminare un utente registrato.&nbsp;<br>Compila il modulo!</p><a class="learn-more" href="#">Apri modulo</a></div>
            </div>
        </div>
    </div>
</div>
